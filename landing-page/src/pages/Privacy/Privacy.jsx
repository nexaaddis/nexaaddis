    ...
    >
      ...
      <Box sx={{ mt: 4 }}>
        ...
        <Typography variant="body1" paragraph>
          At NexaAddis, protecting your privacy is of utmost importance. This Privacy Policy outlines the types of personal information we receive and collect when you use our website or services and how we safeguard your information.
        </Typography>
        <Typography variant="body1" paragraph>
      ...
      <Box sx={{ mt: 4 }}>
        ...
        <Typography variant="body1" paragraph>
          These Terms & Conditions ("Terms") govern your use of the NexaAddis website and services. By accessing or using our website, you agree to comply with these Terms.
        </Typography>
        <Typography variant="body1" paragraph>
        ...
        <Typography variant="body1" paragraph>
          <strong>Intellectual Property:</strong> All content, including text, graphics, logos, and software, on our website is owned by NexaAddis and is protected by copyright, trademark, and other intellectual property laws. Unauthorized use of our content is prohibited and may result in legal action.
        </Typography>
        <Typography variant="body1" paragraph>
          <strong>Limitation of Liability:</strong> NexaAddis will not be liable for any indirect, incidental, or consequential damages arising from your use of our website or services. Our liability is limited to the fullest extent permitted by law, including under Ethiopian regulations.
        </Typography>
        <Typography variant="body1" paragraph>
        ...
        <Typography variant="body2">
          - Email: nexaaddis@gmail.com
        </Typography>
        <Typography variant="body2">
          - Phone: +251 963 431 572
        </Typography>
        <Typography variant="body2">
